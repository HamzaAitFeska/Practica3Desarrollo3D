...
public class AudioController : MonoBehaviour
{
    ...
    public AudioSource madremiaCR7, buttonClick, checkpointReached, doubleJump, marioTakeDamage, marioDies, punchSingle, punchDouble, kick, backgroundMusic, gameoverMusic;
